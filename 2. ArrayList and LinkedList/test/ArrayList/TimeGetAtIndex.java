...
public class TimeGetAtIndex implements DataSeries {
	...
	public double[] yAxis() throws Throwable {
			...
			for(int index = 0; index < xAxis.length; index++){
				...
				// create 200 arrays, each array has the size of current xAxis[index]
            ...
            // Timing
				// count how long to access the middle one in all 200 arrays. 
            long start = System.currentTimeMillis();
				for(int r = 0; r < repeats; r++){
					target[r].get((int)n/2);
				}
